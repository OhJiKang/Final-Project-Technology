...
def find_subgraph_with_number_items(transactions, num_of_item=2):
    ...
    for transaction in transactions:
        ...
        if len(transaction) > 1:
            flagNotToDo=False
            subgraph = frozenset(subgraphList[:2])
